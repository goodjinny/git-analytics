...
final class ReportDefinitions
{
    ...
    /**
     * Keys generated by default (commits-* and lines-*; excludes reverts-*).
     * Used when neither --with-reverts-report nor --report=reverts-* is passed.
     */
    public static function defaultKeys(): array
    {
        return array_values(array_filter(
            array_keys(self::REPORTS),
            static fn(string $k) => !str_starts_with($k, 'reverts-')
        ));
    }
